...
| [ADR-002](../adr/ADR-002-content-markdown-in-git.md) | Content come markdown-in-git via porta ContentSource, nessun CMS | 2026-08-23 | Accepted (dominio implementato, repo contenuti creato; adapter filesystem ancora da scrivere) |
